...
<form method="POST" action="SendMail.php">
	<div class="bg-container-contact100" style="background-image: url(../Assets/Images/Contact.png);">
	...
	<div class="container-contact100">
		<div class="wrap-contact100">
			...
			<div class="contact100-form-title" style="background-color: transparent;">
			...
			<form class="contact100-form validate-form">
				...
				<div class="wrap-input100 validate-input">
					<input id="phone" class="input100" type="text" name="phone" placeholder="+961 ....">
					<span class="focus-input100"></span>
